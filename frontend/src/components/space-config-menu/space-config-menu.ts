...
export class DT3DSpaceConfigMenu extends LitElement {
	...
	private fields: DynamicFormField[] = [
		...
		{
			label: localManager.get("wallCreationDefaults"),
			attribute: "wall-creation-defaults",
			type: "sub-form",
			enabled: true,
			fields: [
				{
					label: localManager.get("automaticFloors"),
					attribute: "floorplan.automaticFloors",
					type: "boolean",
				...
				},
				{
					...
					attribute: "floorplan.connection.shape",
					type: "select",
				...
				},
				{
					...
					attribute: "floorplan.wall.height",
					type: "number",
				...
				},
				{
					...
					attribute: "floorplan.wall.color",
					type: "color",
				...
				},
				{
					...
					attribute: "floorplan.wall.decoration.enabled",
					type: "boolean",
				...
				},
				{
					...
					attribute: "floorplan.wall.decoration.height",
					type: "number",
				...
				},
				{
					...
					attribute: "floorplan.wall.decoration.depth",
					type: "number",
				...
				},
				{
					...
					attribute: "floorplan.wall.decoration.color",
					type: "color",
