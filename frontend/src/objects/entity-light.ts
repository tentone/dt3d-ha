import { CanvasTexture, Color, Group, PointLight, Sprite, SpriteMaterial } from "three";
...
export class EntityLight extends Group {
    public constructor(entityId: string, entity: any) {
        ...
        const label = createTextSprite(entity.attributes?.friendly_name ?? entityId, 256, 96);
